    ...
    <div>
      <form action="#" method="post" enctype="multipart/form-data">
        <div class="row">
          <div class="col-4">
            <p>Название товара</p>
            <input type="text" name="name" placeholder="" value="<?php echo $product['product_name']; ?>">
          </div>
          ...
          <div class="col-4">
            <p>Скидка</p>
            <input type="text" name="sale" placeholder="" value="<?php echo $product['sale']; ?>">
          </div>
          ...
          <div class="col-12">
            ...
            <textarea title="Описание" name="description" placeholder="<?php echo $product['description']; ?>"></textarea>
          </div>
