...
<div class="banner">
  <div class="banner-content">
    <div data-offset="40" class="banner-images parallax p-image">
      <img class="men" src="/template/img/men.png" alt="men">
      <img class="woman" src="/template/img/women.png" alt="woman">
    </div>
    <div data-offset="80" class="banner-data parallax p-image">
...
<section class="content">
  ...
  <div class="collection row">
    <div class="collection-items col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
      <div class="animated-box">
        <div class="overly orange"></div>
        <img src="/template/img/glasses.png" alt="">
    ...
    <div class="collection-items col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
      <div class="animated-box">
        ...
        <img src="/template/img/bags.png" alt="">
        <div class="box-container">
          <div class="box-text">
            <h3>bags</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
    ...
    <div class="collection-items col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
      <div class="animated-box">
        <div class="overly green"></div>
        <img src="/template/img/sneakers.png" alt="">
        <div class="box-container">
          <div class="box-text">
            <h3>sneakers</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
    ...
    <div class="collection-items col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
      <div class="animated-box">
        <div class="overly electric-purple"></div>
        <img src="/template/img/access.png" alt="">
        <div class="box-container">
          <div class="box-text">
            <h3>accessories</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
